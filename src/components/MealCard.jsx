...
function MealCard({ meal, isFavorite, onViewDetails, onToggleFavorite }) {
  return (
    <article className="overflow-hidden rounded-[26px] border border-orange-100 bg-white/80 shadow-soft transition duration-300 hover:-translate-y-1 hover:shadow-[0_25px_45px_-25px_rgba(249,115,22,0.65)]">
